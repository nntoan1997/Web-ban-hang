<?php
include "connect.php";
$mota="";$gia="";$tensp="";$ghichu="";$mota_ngan="";
if(isset($_POST["act"]))
{//(1)
	$loaisp=$_POST["loaisp"];
	...
	$kt="select count(*) from sanpham where sanpham.tensp='$tensp'";
	...
	{//(3)
		$n=$_REQUEST["n"];
		if($n=="menu")
			$sql="insert into sanpham(id,tensp,mota,hinh,gia,ghichu,id_menu,mota_ngan,noibat) values ('$id','$tensp','$mt','$newName','$gia','$ghichu',$menu,'$mtn','$noibat')";
	}//(3)
	else{
		$sql="insert into sanpham(id,id_loai,tensp,mota,hinh,gia,ghichu,mota_ngan,noibat) values ('$id',$loaisp,'$tensp','$mt','$newName','$gia','$ghichu','$mtn','$noibat')";}
echo "$sql<hr>";
	$kq=mysql_query($sql);
	if(!$kq){
...
//********************************resize hinh ********************************//	
		...
		$loaisp="";$mota="";$gia="";$tensp="";$ghichu="";$mota_ngan="";$mt="";$splitmt[]="";
	}//(4)
...
<table width="900" border="0" cellspacing="0" cellpadding="0" ">
  ...
  <tr bgcolor="#FFFFFF">
    ...
    <td><textarea name="mota_ngan" cols="27" rows="5"  style="width:240px"></textarea> </td>
  </tr>
  <tr bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <td>   
    <select name="noibat" style="width:240x" >
    <option value="chonmenu">----------Chọn----------</option>
