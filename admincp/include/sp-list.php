...
<table width="900" height="70" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
	  <tr>
...
<table width="900" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr height="30" bgcolor="#ffcc99">
    ...
    <td align="center" width="100" style="border-right:1px solid #333"><strong>Mô tả ngắn</strong></td>
...
<?php
  ...
  <input type="checkbox" name="chon[]" value="<?php echo $id; ?>"/></td>  
	...
	<div align="center" style="padding-left:3px; padding-right:3px;" onclick="var win=window.open('mota_ngan.php?id=<?php echo $id; ?>', 'open_window', 'width=570, height=320, left=0, top=0')">Xem mô tả</div></td>
